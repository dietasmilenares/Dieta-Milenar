            ...
            activePlans.length === 0 ? (
              ...
              <div className="flex gap-4 overflow-x-auto pb-2 snap-x snap-mandatory" style={{ scrollbarWidth: 'none' }}>
                {activePlans.map(plan => (
                  <div key={plan.id} className={`bg-black rounded-lg border flex-shrink-0 snap-start overflow-hidden ${plan.isPopular ? 'border-[#D4AF37]' : 'border-gray-800'}`} style={{ minWidth: '260px', width: '260px' }}>
