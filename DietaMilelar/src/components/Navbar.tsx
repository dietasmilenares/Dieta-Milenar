              ...
              >
                <ul className="flex flex-col gap-4 text-center">
                  {currentUser && (
                    <li>
                      <button
                        onClick={() => { window.location.href = '/'; setShowNavMenu(false); }}
                        className="text-[#D4AF37] hover:text-white transition-colors font-heading text-lg uppercase tracking-widest"
                      >
                        Área do Membro
                      </button>
                    </li>
