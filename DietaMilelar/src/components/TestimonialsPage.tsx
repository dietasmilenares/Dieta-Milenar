    ...
    if (!isPlaying) {
      return (
        ...
        >
          ...
          <div className="relative z-10 w-20 h-20 bg-[#D4AF37] rounded-full flex items-center justify-center pl-1 shadow-[0_0_50px_rgba(212,175,55,0.4)] group-hover:scale-110 transition-transform duration-300 border border-white/20">
  ...
  const testimonials = [
    {
      ...
      lost: "24kg",
      time: "2 meses",
      videoThumbnail: "https://i.ibb.co/gFw8Fg14/file-000000005554720eabf5c2b4482e00d2.png",
      rating: 5,
    ...
    },
    {
      ...
      lost: "12kg",
      time: "2 meses",
      videoThumbnail: "https://i.ibb.co/4RbnPspv/file-00000000632471f5881d87c470e88f53.png",
      rating: 5,
