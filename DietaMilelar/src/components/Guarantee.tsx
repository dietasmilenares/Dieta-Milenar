    ...
    <section className="py-16 md:py-24 bg-gradient-to-br from-gray-900 to-black border-y border-[#D4AF37]/20">
      ...
      <div className="container mx-auto px-4 max-w-4xl text-center">
        ...
        <p className="text-sm md:text-lg text-white mb-8 leading-relaxed">
          Aplique o método por 7 dias. Se você não sentir seu metabolismo acelerar, suas roupas ficarem mais largas e sua energia aumentar, nós devolvemos 100% do seu dinheiro. Sem perguntas. O risco é todo nosso.
        </p>
      </div>
    </section>
  );
