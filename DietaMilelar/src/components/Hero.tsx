...
export const Hero: React.FC<HeroProps> = ({ onCTAClick }) => {
  ...
  const renderVideo = () => {
    const videoUrl = globalSettings.heroVideoUrl;
          ...
          <div className="absolute inset-0 bg-black rounded-xl overflow-hidden">
            {!isPlaying ? (
              ...
              >
                ...
                />
                <div className="relative w-20 h-20 bg-[#D4AF37]/90 rounded-full flex items-center justify-center pl-1 shadow-[0_0_30px_rgba(212,175,55,0.6)] group-hover:scale-110 transition-transform border border-white/20 z-10">
