...
--
-- Host: localhost
-- Tempo de geração: 24/03/2026 às 11:32
...
CREATE TABLE `notifications` (
  ...
  `type` enum('commission','rejection','system','proof') COLLATE utf8mb4_unicode_ci DEFAULT 'system',
...
CREATE TABLE `plans` (
  ...
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `checkout_url` varchar(2048) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
